...
app = Tk()
app.title("Welcome")
img =Image.open('D:\\signlanguage\\bg image.jpg')
...
# Add text
label2 = Label(app, text = "HANDGESTURE RECOGNITION AND VOICE CONVERSION FOR DEAF AND APHONIC PEOPLE",bg="#3db7bf",
...
def button5():
    os.system('python voice_to_gesture.py')
...
b1=tk.Button(app,text="voice_to_gesture",command=button5,bg="#3db7bf",activebackground="#c21d54",fg="black",font=('Arial',16),height=2,width=20)
